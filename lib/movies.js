...
var getTomatoesFromTitle = function(title, callback) {
    ...
    http.get(uri, function(res) {
        ...
        if (res.statusCode !== 403) {
            ...
            utils.log('Rottentomatoes rejected connection. Check your api-key.')
            callback('');
        }
    });
};
...
setTimeout(updateFeeds(function(e){utils.log(e)}), 6000);

setInterval(updateFeeds(function(e){utils.log(e)}), config.updateIntervalFeeds);
