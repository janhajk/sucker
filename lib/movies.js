...
var updateFeeds = function(callback) {
    ...
    rssGet(function(rssItems) {
        console.log('retrieved ' + rssItems.length + ' items from feeds');
        ...
        for(var i in movies) {
            db.movie.exists(movies[i], function(exists, movieEntry, movieInput) {
                ...
                if(exists) {
                    ...
                    } else console.log('No new links found for ' + movieEntry.title);
                }
                // add new movie
                else {
...
setTimeout(updateFeeds(function(e){console.log(e)}), 6000);

setInterval(updateFeeds(function(e){console.log(e)}), config.updateIntervalFeeds);
